...
st.image("https://www.seventhgenerationadvisors.org/wp-content/uploads/2018/05/stock-exchange-value.jpg")
...
# redirect urls
github_redirect_url = "https://github.com/Peter-Liang/CodeWars-Python/blob/master/solutions/Consecutive_strings.py"
...
st.markdown(f'<div class="footer">Made with ❤️ by Muhammad Sufyan Khalid<a href="{github_redirect_url}"><img src="{github_url}" width="30" height="30"></a>'
             f'<a href="{twitter_redirect_url}"><img src="{twitter_url}" width="30" height="30"></a>'
             f'<a href="{medium_redirect_url}"><img src="{medium_url}" width="30" height="30"></a> | Credits: Dr. Muhammad Abbas Abbasi </div>', unsafe_allow_html=True)